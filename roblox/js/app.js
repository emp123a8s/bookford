(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
            ...
            on: {
                init: function() {
                    const wrapButton = document.querySelector(".page__slider-wrap-button");
                    if (this.slides.length <= 1) {
                        ...
                        wrapButton.classList.add("first-slide");
                    }
                },
                slideChange: function() {
                    ...
                    wrapButton.classList.remove("first-slide", "last-slide", "middle-slide");
                    if (this.activeIndex === 0) {
                        ...
                        wrapButton.classList.add("last-slide");
                    } else {
                        prevButton.style.display = "block";
                        nextButton.style.display = "block";
                        wrapButton.classList.add("middle-slide");
                    }
                }
            }
        });
